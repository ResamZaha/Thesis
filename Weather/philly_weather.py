...
def getFileName(dt):
    return "data_philly/weather_data_"+str(dt.year)+"_"+str(dt.month)+"_"+str(dt.day)+".json"
...
while dt < end:
    ...
    url = "https://api.weather.com/v1/location/KPHL:9:US/observations/historical.json?apiKey=e1f10a1e78da46f5b10a1e78da96f525&units=m&startDate=" + \
